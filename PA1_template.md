...
![plot of chunk most-steps-interval](figure/most-steps-interval-1.png)
...
* There are 17,568 records.
* 2,304 are missing a steps value.
* This is 13% of the records.
...
![plot of chunk adjusted-mean-steps-day](figure/adjusted-mean-steps-day-1.png)

* Missing step values for an interval have been replaced with the average for that interval over all days.
* This created an extra 86,130 steps over two months.
...
![plot of chunk average-steps-weekend-weekday](figure/average-steps-weekend-weekday-1.png)
